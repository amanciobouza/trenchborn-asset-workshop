param(
    [string]$OutputPath = "dist/LargeCityCentralHospitalPackage.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "largecity-central-hospital.package.project.json"
...
Write-Host "Hospital package created: $resolvedOutput"
