param(
    [string]$OutputPath = "dist/LargeCityUptownArenaPackage.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "largecity-uptown-arena.package.project.json"
...
Write-Host "Large City Uptown Arena package created: $resolvedOutput"
