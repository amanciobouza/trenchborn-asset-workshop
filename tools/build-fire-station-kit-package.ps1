param(
    [string]$OutputPath = "dist/FireStationKit.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "fire-station-kit.package.project.json"
...
Write-Host "Fire Station Kit package created: $resolvedOutput"
