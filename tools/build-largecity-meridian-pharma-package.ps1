param(
    [string]$OutputPath = "dist/LargeCityMeridianPharmaPackage.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "largecity-meridian-pharma.package.project.json"
...
Write-Host "Large City Meridian Pharma package created: $resolvedOutput"
