param(
    [string]$OutputPath = "dist/LargeCityStadiumPackage.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "largecity-stadium.package.project.json"
...
Write-Host "Large City Stadium package created: $resolvedOutput"
