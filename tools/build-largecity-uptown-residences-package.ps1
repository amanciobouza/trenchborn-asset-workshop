param(
    [string]$OutputPath = "dist/LargeCityUptownResidencesPackage.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "largecity-uptown-residences.package.project.json"
...
Write-Host "Large City Uptown Residences package created: $resolvedOutput"
