...
FILES=['KaijuBuildingTraversal.lua','KaijuPresentation.lua','KaijuPresentationClient.client.lua','KaijuPresentationBootstrap.lua','KaijuSkeleton.lua','KaijuStageOneInstaller.lua','KaijuEvolutionBlockout.lua','KaijuStageOneRig.lua',
...
def build():
    ...
    installer=(SOURCE/'KaijuStageOneInstaller.lua').read_text(encoding='utf-8')
