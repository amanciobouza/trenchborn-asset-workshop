...
FILES=['KaijuPresentation.lua','KaijuPresentationClient.client.lua','KaijuPresentationBootstrap.lua','KaijuSkeleton.lua','KaijuStageOneInstaller.lua','KaijuEvolutionBlockout.lua','KaijuStageOneRig.lua',
