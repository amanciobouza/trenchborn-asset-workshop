param(
    [string]$OutputPath = "dist/LargeCityWaterfrontResortPackage.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "largecity-waterfront-resort.package.project.json"
...
Write-Host "Waterfront Resort package created: $resolvedOutput"
