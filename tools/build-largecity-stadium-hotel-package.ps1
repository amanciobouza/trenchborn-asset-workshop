param(
    [string]$OutputPath = "dist/LargeCityStadiumHotelPackage.rbxmx"
)

$ErrorActionPreference = "Stop"
$projectRoot = Split-Path -Parent $PSScriptRoot
$projectFile = Join-Path $projectRoot "largecity-stadium-hotel.package.project.json"
...
Write-Host "Large City Stadium Hotel package created: $resolvedOutput"
