...
model:SetAttribute("ReviewScene", "LargeCitySummitTower_Isolated_Phase4")
...
print("[Trenchborn Asset Workshop] Summit Tower Phase 4 Golden Master ready for review:", model:GetFullName())
