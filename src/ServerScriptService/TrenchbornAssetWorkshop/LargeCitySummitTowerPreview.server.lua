...
model:SetAttribute("ReviewScene", "LargeCitySummitTower_Isolated_Phase5_DressingReview")
...
print("[Trenchborn Asset Workshop] Summit Tower Phase 5 dressing ready for review:", model:GetFullName())
