...
model:SetAttribute("ReviewScene", "LargeCityMeridianPharma_Isolated_Phase4_GoldenMasterReview")
...
print("[Trenchborn Asset Workshop] Meridian Pharma Phase 4 Golden Master ready for review:", model:GetFullName())
