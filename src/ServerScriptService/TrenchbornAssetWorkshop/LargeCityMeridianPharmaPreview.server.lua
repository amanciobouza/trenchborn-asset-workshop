...
local targetX = spawnPosition.X + 155
...
model:SetAttribute("ReviewScene", "LargeCityMeridianPharma_Isolated_Phase6_ExternalGameTestPending")
...
print("[Trenchborn Asset Workshop] Meridian Pharma visual review approved; external game test pending:", model:GetFullName())
print("[Trenchborn Asset Workshop] Meridian Pharma ground contact Y/correction:", groundY, model:GetAttribute("GroundContactCorrection"))
