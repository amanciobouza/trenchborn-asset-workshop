...
model:SetAttribute("ReviewScene", "LargeCityMeridianPharma_Isolated_Phase5_DressingReview")
...
print("[Trenchborn Asset Workshop] Meridian Pharma Phase 5 dressing ready for review:", model:GetFullName())
