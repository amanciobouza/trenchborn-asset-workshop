...
workshop:SetAttribute("ReviewScene", "LargeCityStadium_Isolated_Phase6_IntegrationPending")
...
print("[Trenchborn Asset Workshop] Large City Stadium Phase 5 approved; Phase 6 shared collapse integration pending:", model:GetFullName())
