...
model:SetAttribute("ReviewScene", "LargeCityUptownResidences_Isolated_Phase6_ExternalGameTestPending")
...
print("[Trenchborn Asset Workshop] Uptown Residences visual review approved; external game test pending:", model:GetFullName())
