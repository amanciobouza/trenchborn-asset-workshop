...
model:SetAttribute("ReviewScene", "LargeCityStadiumHotel_Isolated_Phase5_DressingReview")
...
print("[Trenchborn Asset Workshop] Stadium Hotel Phase 5 dressing ready for review:", model:GetFullName())
