...
model:SetAttribute("ReviewScene", "LargeCityUptownParking_Isolated_Phase4_GoldenMasterReview")
...
print("[Trenchborn Asset Workshop] Uptown Parking Phase 4 Golden Master ready for review:", model:GetFullName())
