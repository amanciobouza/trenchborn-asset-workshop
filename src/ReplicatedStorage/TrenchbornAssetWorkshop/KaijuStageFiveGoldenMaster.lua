-- Stage 5 geometry and dressing approved by user; Phase 7 final package.
...
function Builder.Build(parent,ground,options)
 ...
 local ok,err=pcall(function()
  ...
  local veinLayouts={
   ["LeftShoulderArmorStage4RearOverlapCore"]={[1]={Width=2.8,P={{.32,-.07},{.24,.15},{.36,.32},{.29,.58},{.41,.79}},E={{1,2,1},{2,3,1},{3,4,.9},{4,5,.65}}}},
   ...
   ["RightHipArmorStage4RearOverlapCore"]={[1]={Width=2.8,P={{.33,-.07},{.25,.16},{.38,.45},{.33,.79}},E={{1,2,1},{2,3,1},{3,4,.85}}}},
   ["LeftShinArmorStage4RearOverlapCore"]={[1]={P={{.44,.08},{.37,.26},{.40,.46},{.27,.70},{.54,.58}},E={{1,2,.5},{2,3,.9},{3,4,.7},{3,5,.3}}}},
   ["RightShinArmorStage4RearOverlapCore"]={[1]={Width=2.8,P={{.23,-.07},{.31,.14},{.41,.36},{.29,.57},{.33,.79}},E={{1,2,.55},{2,3,.85},{3,4,1},{4,5,1}}}},
   ...
   ["LeftShoulderArmorStage4UpperArmOverlapCore"]={[1]={Width=2.8,P={{.21,-.07},{.33,.18},{.27,.44},{.32,.79},{.48,.49}},E={{1,2,.55},{2,3,.85},{3,4,1},{3,5,.25}}}},
   ...
   ["LeftHipArmorStage4Lame1RaisedFaceCore"]={[1]={Width=2.8,P={{.33,-.07},{.27,.18},{.37,.41},{.33,.79}},E={{1,2,1},{2,3,1},{3,4,.85}}}},
   ["LeftHipArmorStage4Lame2RaisedFaceCore"]={[1]={Width=2.8,P={{.33,-.07},{.42,.20},{.31,.48},{.33,.79}},E={{1,2,1},{2,3,.95},{3,4,1}}}},
   ["RightHipArmorStage4Lame2RaisedFaceCore"]={[1]={P={{.03,.59},{.19,.45},{.38,.46},{.56,.35},{.38,.67}},E={{1,2,.55},{2,3,.9},{3,4,.65},{3,5,.3}}}},
   ["LeftShinArmorStage4KneecapRaisedFaceCore"]={[1]={Width=2.8,P={{.33,-.07},{.26,.22},{.36,.51},{.33,.79}},E={{1,2,1},{2,3,1},{3,4,1}}}},
   ["RightShinArmorStage4KneecapRaisedFaceCore"]={[1]={P={{.44,.08},{.37,.31},{.39,.53}},E={{1,2,.8},{2,3,.45}}}},
   ["LeftShinArmorRockLayer1Core"]={[1]={Width=2.8,P={{.26,-.07},{.32,.13},{.25,.39},{.36,.59},{.33,.79}},E={{1,2,.55},{2,3,.85},{3,4,1},{4,5,1}}}},
  ...
  model:SetAttribute("PipelinePhase",7);model:SetAttribute("QualityGateA","ApprovedByUser")
  model:SetAttribute("QualityGateB","ApprovedByUser");model:SetAttribute("QualityGateC","ApprovedByUser")
  ...
  model:SetAttribute("Purpose","Stage 5 approved geometry and dressing; gameplay approved by user")
  model.Parent=parent
 end)
 staging:Destroy()
