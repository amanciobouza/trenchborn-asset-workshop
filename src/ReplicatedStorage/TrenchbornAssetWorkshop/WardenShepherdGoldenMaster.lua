...
local function addArm(rig, armor, side, sign)
	...
	cylinder(armor, side .. "ShoulderJointCover", Vector3.new(1.3, 3.55, 3.55), Vector3.new(sign * 7.35, 30.4, -3.18), COLORS.Body, Vector3.new(0, 90, 0))
	cylinder(armor, side .. "ShoulderJointHub", Vector3.new(0.8, 2.35, 2.35), Vector3.new(sign * 7.35, 30.4, -4.18), COLORS.DarkMetal, Vector3.new(0, 90, 0))
...
local function addTorso(rig, armor, systems)
	...
	block(armor, "ChestUpper", Vector3.new(9.1, 2.25, 1.4), Vector3.new(0, 31.65, -3.65), COLORS.Armor)
	block(armor, "ChestMiddle", Vector3.new(7.4, 2.25, 1.3), Vector3.new(0, 29.5, -3.8), COLORS.Body)
	block(armor, "ChestLower", Vector3.new(5.5, 2.1, 1.2), Vector3.new(0, 27.38, -3.95), COLORS.Armor)
	block(armor, "ChestTopLeft", Vector3.new(4.65, 1.2, 1.45), Vector3.new(-2.65, 33.15, -3.25), COLORS.Armor, Vector3.new(0, 4, -7))
	block(armor, "ChestTopRight", Vector3.new(4.65, 1.2, 1.45), Vector3.new(2.65, 33.15, -3.25), COLORS.Armor, Vector3.new(0, -4, 7))
	block(armor, "ChestWingLeft", Vector3.new(4.1, 5.65, 1.5), Vector3.new(-5.05, 30.45, -2.78), COLORS.Armor, Vector3.new(0, 9, -13))
	block(armor, "ChestWingRight", Vector3.new(4.1, 5.65, 1.5), Vector3.new(5.05, 30.45, -2.78), COLORS.Armor, Vector3.new(0, -9, 13))
...
function Builder.Build(parent)
	...
	model:SetAttribute("GoldenMasterIteration", 10)
	model.Parent = parent
