...
local function addTorso(rig, armor, systems)
	...
	block(armor, "ChestMain", Vector3.new(7.7, 7.8, 1.5), Vector3.new(0, 29.25, -3.45), COLORS.Body)
	block(armor, "ChestSternum", Vector3.new(4.9, 6.4, 0.7), Vector3.new(0, 29.35, -4.5), COLORS.Armor)
	block(armor, "ChestTop", Vector3.new(10.6, 2.2, 1.8), Vector3.new(0, 33.2, -3.35), COLORS.Armor)
	block(armor, "ChestWingLeft", Vector3.new(4.8, 7.5, 1.7), Vector3.new(-5.0, 30.0, -2.95), COLORS.Armor, Vector3.new(0, 10, -15))
	block(armor, "ChestWingRight", Vector3.new(4.8, 7.5, 1.7), Vector3.new(5.0, 30.0, -2.95), COLORS.Armor, Vector3.new(0, -10, 15))
	block(armor, "ChestCollarLeft", Vector3.new(4.1, 1.0, 1.25), Vector3.new(-3.35, 32.25, -4.0), COLORS.DarkMetal, Vector3.new(0, 7, -8))
	block(armor, "ChestCollarRight", Vector3.new(4.1, 1.0, 1.25), Vector3.new(3.35, 32.25, -4.0), COLORS.DarkMetal, Vector3.new(0, -7, 8))
	...
	neon(core, "ShieldAngleLeft", Vector3.new(0.55, 4.8, 0.35), CFrame.new(-1.15, 29.0, -4.9) * CFrame.Angles(0, 0, math.rad(-25)))
	neon(core, "ShieldAngleRight", Vector3.new(0.55, 4.8, 0.35), CFrame.new(1.15, 29.0, -4.9) * CFrame.Angles(0, 0, math.rad(25)))
...
function Builder.Build(parent)
	...
	model:SetAttribute("GoldenMasterIteration", 3)
	model.Parent = parent
