...
local function addLeg(rig, armor, side, sign)
	...
	block(armor, side .. "ShinPlate", Vector3.new(4.6, 6.7, 4.3), Vector3.new(shinX, 7.9, -0.15), COLORS.Body, Vector3.new(0, 0, legLean))
...
local function addArm(rig, armor, side, sign)
	...
	block(armor, side .. "ShoulderCap", Vector3.new(5.6, 4.35, 5.4), Vector3.new(sign * 9.0, 30.55, 0), COLORS.Armor, Vector3.new(0, -sign * 3, shoulderTilt))
...
local function addTorso(rig, armor, systems)
	...
	block(armor, "ChestSternum", Vector3.new(6.0, 5.25, 0.5), Vector3.new(0, 29.35, -4.33), COLORS.Armor)
	block(armor, "ChestTopLeft", Vector3.new(5.0, 1.45, 1.55), Vector3.new(-2.75, 33.05, -3.2), COLORS.Armor, Vector3.new(0, 4, -5))
	block(armor, "ChestTopRight", Vector3.new(5.0, 1.45, 1.55), Vector3.new(2.75, 33.05, -3.2), COLORS.Armor, Vector3.new(0, -4, 5))
	block(armor, "ChestWingLeft", Vector3.new(4.25, 5.9, 1.55), Vector3.new(-5.0, 30.25, -2.82), COLORS.Armor, Vector3.new(0, 8, -11))
	block(armor, "ChestWingRight", Vector3.new(4.25, 5.9, 1.55), Vector3.new(5.0, 30.25, -2.82), COLORS.Armor, Vector3.new(0, -8, 11))
	...
	neon(core, "ShieldAngleLeft", Vector3.new(0.5, 4.15, 0.28), CFrame.new(-0.95, 29.45, -4.75) * CFrame.Angles(0, 0, math.rad(25)))
	neon(core, "ShieldAngleRight", Vector3.new(0.5, 4.15, 0.28), CFrame.new(0.95, 29.45, -4.75) * CFrame.Angles(0, 0, math.rad(-25)))
...
function Builder.Build(parent)
	...
	model:SetAttribute("GoldenMasterIteration", 6)
	model.Parent = parent
