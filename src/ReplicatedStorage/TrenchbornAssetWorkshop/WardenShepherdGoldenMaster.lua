...
local function addLeg(rig, armor, side, sign)
	...
	cylinder(armor, side .. "KneeJointHub", Vector3.new(0.5, 1.95, 1.95), Vector3.new(kneeX, 11.9, -3.72), COLORS.Chassis, Vector3.new(0, 90, 0))
...
local function addTorso(rig, armor, systems)
	...
	block(armor, "ChestSlopeLeft", Vector3.new(3.75, 6.4, 1.35), Vector3.new(-3.55, 30.0, -3.35), COLORS.Armor, Vector3.new(0, 7, 14))
	block(armor, "ChestSlopeRight", Vector3.new(3.75, 6.4, 1.35), Vector3.new(3.55, 30.0, -3.35), COLORS.Armor, Vector3.new(0, -7, -14))
...
function Builder.Build(parent)
	...
	model:SetAttribute("GoldenMasterIteration", 12)
	model.Parent = parent
