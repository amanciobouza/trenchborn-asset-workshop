...
local function addTorso(rig, armor, systems)
	...
	block(armor, "ChestMain", Vector3.new(7.1, 7.6, 1.45), Vector3.new(0, 29.15, -3.35), COLORS.Body)
	block(armor, "ChestSternum", Vector3.new(4.4, 5.9, 0.5), Vector3.new(0, 29.2, -4.33), COLORS.Armor)
	...
	block(armor, "ChestWingLeft", Vector3.new(4.35, 7.1, 1.55), Vector3.new(-4.9, 29.8, -2.82), COLORS.Armor, Vector3.new(0, 8, -14))
	block(armor, "ChestWingRight", Vector3.new(4.35, 7.1, 1.55), Vector3.new(4.9, 29.8, -2.82), COLORS.Armor, Vector3.new(0, -8, 14))
	...
	neon(core, "ShieldAngleLeft", Vector3.new(0.5, 4.45, 0.28), CFrame.new(-1.05, 28.95, -4.75) * CFrame.Angles(0, 0, math.rad(-25)))
	neon(core, "ShieldAngleRight", Vector3.new(0.5, 4.45, 0.28), CFrame.new(1.05, 28.95, -4.75) * CFrame.Angles(0, 0, math.rad(25)))
...
function Builder.Build(parent)
	...
	model:SetAttribute("GoldenMasterIteration", 4)
	model.Parent = parent
