...
function Harness.Attach(model)
	...
	local actions = {
		...
		SiegeFistCombo = function() end,
		GroundSlam = function() end,
		DistrictShield = function() end,
	...
	model:SetAttribute("BastionDistrictShieldPreviewReady", true)
